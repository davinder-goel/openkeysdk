...
//
//public class KabaOlder implements LegicMobileSdkSynchronizeEventListener,
...
//
//    //-----------------------------------------------------------------------------------------------------------------|
//    public KabaOlder(Application context, OpenKeyCallBack openKeyCallBack) {
...
//                                        scope.setTag("KABA openingStatus", e.getLocalizedMessage()+"Line 412");
//                                        Sentry.captureMessage("KABA openingStatus->Line 412"+e.getLocalizedMessage());
//                                    });
//                                }
//                                break;
//                            } else
...
//            } catch (LegicMobileSdkException e) {
//                Sentry.configureScope(scope -> {
//                    scope.setTag("KABA openingStatus", e.getLocalizedMessage()+"Line 422");
//                    Sentry.captureMessage("KABA openingStatus->Line 427"+e.getLocalizedMessage());
//                });
//                Log.e("Kaba", e.getLocalizedMessage());
//            } catch (Exception e) {
//                Sentry.configureScope(scope -> {
//                    scope.setTag("KABA openingStatus", e.getLocalizedMessage()+"Line 428");
//                    Sentry.captureMessage("KABA openingStatus->Line 433"+e.getLocalizedMessage());
//                });
...
//        } catch (LegicMobileSdkException e) {
//            Sentry.configureScope(scope -> {
//                scope.setTag("KABA openingStatus", e.getLocalizedMessage()+"Line 435");
//                Sentry.captureMessage("KABA openingStatus->Line 441"+e.getLocalizedMessage());
//            });
//            e.printStackTrace();
//        }
//    }
...
//                    Log.e("Kaba", e.getLocalizedMessage());
//                    Sentry.configureScope(scope -> {
//                        scope.setTag("KABA openingStatus", e.getLocalizedMessage()+"Line 456");
//                        Sentry.captureMessage("KABA openingStatus->Line 461"+e.getLocalizedMessage());
//                    });
//                }
//            }
//        } catch (LegicMobileSdkException e) {
//            Log.e("Kaba", e.getLocalizedMessage());
//            Sentry.configureScope(scope -> {
//                scope.setTag("KABA openingStatus", e.getLocalizedMessage()+"Line 468");
//                Sentry.captureMessage("KABA openingStatus->Line 469"+e.getLocalizedMessage());
//            });
//        }
//    }
//
...
//        Sentry.configureScope(scope -> {
//            scope.setTag("KABA openingStatus", messageData+"Line 507");
//            Sentry.captureMessage("KABA openingStatus->Line 508"+messageData);
//        });
//        try {
//            mManager.sendLcMessage(messageData, LcMessageMode.ENCRYPTED_MACED_FILE_KEYS, rfInterface);
//        } catch (LegicMobileSdkException e) {
//            Sentry.configureScope(scope -> {
//                scope.setTag("KABA openingStatus", e.getLocalizedMessage()+"Line 505");
//                Sentry.captureMessage("KABA openingStatus->Line 511"+e.getLocalizedMessage());
//            });
//        }
//    }
//
...
//        Sentry.configureScope(scope -> {
//            scope.setTag("KABA openingStatus", "Line 521");
//            Sentry.captureMessage("KABA openingStatus->Line 522 readerWriteFileEvent");
//        });
//    }
//
//    //-----------------------------------------------------------------------------------------------------------------|
...
//        }
//        Sentry.configureScope(scope -> {
//            scope.setTag("KABA openingStatus", Utils.dataToByteString(data)+"Line 553");
//            Sentry.captureMessage("KABA openingStatus->Line 558"+Utils.dataToByteString(data));
//        });
...
//        Sentry.configureScope(scope -> {
//            scope.setTag("KABA openingStatus", lcMessageMode.name()+"Line 574");
//            Sentry.captureMessage("KABA openingStatus->Line 574"+lcMessageMode.name());
//        });
//    }
//
//    //-----------------------------------------------------------------------------------------------------------------|
...
//                                   RfInterface rfInterface) {
//        Sentry.configureScope(scope -> {
//            scope.setTag("KABA openingStatus", "On Connect"+"Line 583");
//            Sentry.captureMessage("KABA openingStatus->On Connect Line 584");
//        });
...
//        Sentry.configureScope(scope -> {
//            scope.setTag("KABA openingStatus", status+"Line 594");
//            Sentry.captureMessage("KABA openingStatus-> Line 5904");
//        });
//        if (status.isSuccess()) {
...
//            Sentry.configureScope(scope -> {
//                scope.setTag("KABA SDK Errors", reason.getReasonType().name()+"Line 601");
//                Sentry.captureMessage("KABA openingStatus->Line 602"+reason.getReasonType().name());
//            });
